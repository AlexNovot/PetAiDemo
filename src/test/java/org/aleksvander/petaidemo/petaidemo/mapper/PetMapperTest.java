...
class PetMapperTest {
    ...
    void toEntity_mapsFieldsAndOwner_doesNotLeakOwnerIdIntoPetId() {
        ...
        PetRequestDto dto = new PetRequestDto("Rex", Species.DOG, "Labrador", LocalDate.of(2020, 1, 1), 99L);
    ...
    void updateEntity_updatesFieldsAndOwner_preservesExistingPetId() {
        ...
        PetRequestDto dto = new PetRequestDto("Bella", Species.CAT, "Siamese", LocalDate.of(2019, 6, 15), 1L);
    ...
    void toDto_mapsOwnerIdFromOwnerAssociation() {
        ...
        assertThat(dto).isEqualTo(new PetResponseDto(10L, "Rex", Species.DOG, "Labrador", LocalDate.of(2020, 1, 1), 7L));
    }
}
